...
function CrearJuego() {
  ...
  //console.log(props, "desde crear juego");
  ...
  const handleChange = (e) => {
    if (e.target.parentNode.parentNode.id === "genres") {
      console.log(e.target.parentNode.parentNode.id, " desde creando juego");
      if (e.target.checked) {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.values(errors).length || checkboxsErrors.length) {
      ...
      console.log(Object.values, "este es el object");
        ...
        <div className={styles.container}>
          ...
          <div className={styles.content}>
            <form onSubmit={handleSubmit} onChange={handleChange}>
              ...
              <div id="platforms" className={styles.plataformas}>
                <div>
